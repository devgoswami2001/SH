...
const steps = [
  ...
  },
  {
    ...
    description: "Seamlessly apply for matched jobs or initiate contact with ideal candidates. HyreSence facilitates the connection for successful placements."
  }
];
    ...
    <div className="text-foreground py-12 sm:py-16"> {/* Ensure bg-background is removed here */}
      ...
      <section className="py-12 md:py-20 bg-gradient-to-b from-primary/10 to-transparent">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            How <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">HyreSence</span> Works
          </h1>
      ...
      <section className="py-16 sm:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-3xl">
          ...
          />
          <h2 className="text-3xl lg:text-4xl font-extrabold tracking-tight text-foreground">
            Ready to Experience the HyreSence Difference?
          </h2>
