  ...
  return (
    <div className="bg-background text-foreground">
      ...
      <section className="py-20 md:py-32 bg-gradient-to-b from-primary/10 to-transparent">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 max-w-md mx-auto text-lg text-muted-foreground sm:text-xl md:mt-8 md:max-w-3xl">
            HyreSence is revolutionizing how companies find and hire top talent, and how professionals build their careers. We're seeking partners to join us on this transformative journey.
          </p>
          <div className="mt-10">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              At HyreSence, we believe in a world where everyone can find fulfilling work and every company can build its dream team, effortlessly.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-secondary/30 dark:bg-slate-800/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-base font-semibold text-primary tracking-wide uppercase">The HyreSence Advantage</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-start">
                ...
                <div className="space-y-4">
                  <p className="text-lg text-muted-foreground">
                    HyreSence leverages cutting-edge AI to:
                  </p>
